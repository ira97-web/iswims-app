    ...
    <div>
      ...
      <div style={styles.card}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <button onClick={() => handlePrintSummaryPdf(`Borang Ringkasan Fakulti ${profile?.fakulti || 'FST'}`, facultyWasteRecords)} style={{ ...styles.button, backgroundColor: '#6f42c1', width: 'auto' }}>
          ...
          <table style={styles.table}>
            <thead>
              <tr style={{ backgroundColor: '#f8f9fa' }}>
                ...
                <th style={styles.th}>Tindakan Penyelaras</th>
              </tr>
            </thead>
            <tbody>
              {facultyWasteRecords.map((item) => (
                <tr key={item.id} style={{ borderBottom: '1px solid #eee' }}>
                  ...
                  <td style={styles.td}>
                    <button onClick={() => handleVerifyStatus(item.id_sisa, 'DISAHKAN_OLEH_PENYELARAS')} style={{ ...styles.smallButton, backgroundColor: '#6f42c1' }}>
                      ✅ Sahkan Penyelaras
                    </button>
                  </td>
                </tr>
